...
namespace ZRTMod.Ammo
{
    public class HomingStarAmmo : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Homing stars is exactly what the super star cannon needs."); // The item's description, can be set to whatever you want.
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Projectiles.ZRTHomingStar>(); // The projectile that weapons fire when using this item as ammunition.
