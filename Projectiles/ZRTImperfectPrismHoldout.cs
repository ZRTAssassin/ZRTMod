...
using ZRTMod.Items.Weapons;

namespace ZRTMod.Projectiles
{
    public class ZRTImperfectPrismHoldout : ModProjectile
    {
        ...
        private const float MinManaConsumptionDelay = 10f;
        ...
        private void FireBeams()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, beamVelocity, ModContent.ProjectileType<ZRTImperfectPrismBeam>(), damage, knockback, Projectile.owner, b, uuid);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color drawColor = ZRTImperfectPrism.OverrideColor;
