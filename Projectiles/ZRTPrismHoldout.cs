...
{
    public class ZRTPrismHoldout : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("ZRT Last Prism");
        ...
        private void FireBeams()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, launchVelocity, ModContent.ProjectileType<ZRTPrismBeam>(), (int)((double)Projectile.damage * 1.35), Projectile.knockBack, Projectile.owner);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color drawColor = ZRTPrism.OverrideColor;
